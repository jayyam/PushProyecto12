            ...
            <div id="course">
                <div class="form-group text-left">
                    ...
                    <input type="text" name="people" class="form-control"
                           ...
                           value="<?= (isset($data['data']['people'])) ? $data['product']->people : '' ?>">
                </div>
                <div class="form-group text-left">
                    ...
                    <input type="text" name="objetives" class="form-control"
                           ...
                           value="<?= (isset($data['data']['objetives'])) ? $data['product']->objetives : '' ?>">
                </div>
                <div class="form-group text-left">
                    ...
                    <input type="text" name="necesites" class="form-control"
                           ...
                           value="<?= (isset($data['data']['necesites'])) ? $data['product']->necesites : '' ?>">
                </div>
            </div>
            <div class="form-group text-left">
                ...
                <input type="text" name="price" class="form-control" pattern="^(\d|-)?(\d|,)*\.?\d*$"
                       ...
                       value="<?= (isset($data['data']['price'])) ? $data['product']->price : '' ?>">
            </div>
    </div>
    <div id="course">
        <div class="form-group text-left">
